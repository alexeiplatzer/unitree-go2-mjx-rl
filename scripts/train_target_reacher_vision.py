...
from quadruped_mjx_rl.terrain_gen.factories import make_empty_terrain
...
if __name__ == "__main__":
    ...
    trained_params = train(
        ...
        training_env=env,
        evaluation_env=None,
        randomization_fn=None,  # functools.partial(terrain_randomize, mj_model=env_model),
        run_in_cell=False,
    )
