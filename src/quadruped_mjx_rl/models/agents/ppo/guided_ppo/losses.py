...
def compute_student_loss(student_params: StudentNetworkParams,
                         teacher_params: TeacherNetworkParams, normalizer_params: Any,
                         data: types.Transition,
                         teacher_network: teacher_networks.TeacherNetworks,
                         student_network: teacher_networks.StudentNetworks) -> Tuple[jnp.ndarray, types.Metrics]:
