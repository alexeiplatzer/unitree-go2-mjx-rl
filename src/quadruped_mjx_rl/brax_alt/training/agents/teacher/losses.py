...
def compute_teacher_loss(
  ...
  """
    ...
    latent_vector = encoder_apply(
        normalizer_params, params.encoder, data.observation
    )
    ...
    terminal_latent = encoder_apply(
        normalizer_params, params.encoder, terminal_obs
    )
