...
#     self.square_side = 2
#     THICKNESS = 0.05
#     self.color = [0.460, 0.362, 0.216, 1.0]
...
#     # Create tile
#     body = spec.worldbody.add_body(pos=grid_loc + [0], name=name)
#     body.add_geom(size=[self.square_side, self.square_side, THICKNESS], rgba=self.color)
#
#     # Simple Geoms
#     x_beginning, y_end = [-self.square_side + THICKNESS] * 2
#     x_end, y_beginning = [self.square_side - THICKNESS] * 2
#
...
#
#     x_beginning = -self.square_side + THICKNESS
#     y_beginning = self.square_side - THICKNESS
#
#     # Create tile
#     body = spec.worldbody.add_body(pos=grid_loc + [0], name=name)
#     body.add_geom(size=[self.square_side, self.square_side, THICKNESS], rgba=self.color)
...
#     self.square_side = 2
#     CUBE_LENGTH = 0.05
#     GRID_SIZE = int(self.square_side / CUBE_LENGTH)
#     STEP = CUBE_LENGTH * 2
#     self.color = [0.460, 0.362, 0.216, 1.0]
#
#     if spec is None:
...
#     body = spec.worldbody.add_body(pos=grid_loc + [0], name=name)
#
#     x_beginning = -self.square_side + CUBE_LENGTH
#     y_beginning = self.square_side - CUBE_LENGTH
...
#     self.square_side = 2
#     HEIGHT = 0.1
#     self.color_RGBA = [0.460, 0.362, 0.216, 1.0]
#
#     if spec is None:
#         spec = mj.MjSpec()
#
...
#         name=name,
#         size=[self.square_side, self.square_side, HEIGHT, HEIGHT / 10],
#         nrow=noise.shape[0],
#         ncol=noise.shape[1],
...
#
#     body = spec.worldbody.add_body(pos=grid_loc + [0], name=name)
#     body.add_geom(type=mj.mjtGeom.mjGEOM_HFIELD, hfieldname=name, rgba=self.color_RGBA)
#
#
...
#     # Plane
#     body = spec.worldbody.add_body(pos=grid_loc + [0], name=name)
#     body.add_geom(size=[self.square_side, self.square_side, THICKNESS], rgba=self.color_RGBA)
#
